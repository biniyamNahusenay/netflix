...
import {
    setMoviesFilter,
    setFilteredMovies,setMoviesYears,setUniqueYears,
...
const AllMovies = () => {
   ...
   const handleGenreClick = (genreId)=>{
    dispatch(setMoviesFilter({selectedGenre:genreId}))
     const filteredgenre = data.filter((movie)=>movie.genre === genreId)
     dispatch(setFilteredMovies(filteredgenre))
   }
            ...
            <input
              ...
              />
                <section className="sorts-container mt-[2rem] ml-[10rem]  w-[30rem]">
                  ...
                  <select className="border p-2 rounded ml-4 text-black" value={moviesFilter.selectedYear}
                  ...
                  <select className="border p-2 rounded ml-4 text-black" value={moviesFilter.selectedSort}
