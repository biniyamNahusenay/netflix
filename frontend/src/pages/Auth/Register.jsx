...
const Register = ()=>{
    ...
    const {search} = useLocation()   // Get the current location object
    const sp = new URLSearchParams(search)  // Create a URLSearchParams object from the search string
    const redirect = sp.get('redirect') || '/' // Get the 'redirect' query parameter or default to '/'
